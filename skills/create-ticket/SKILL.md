...
11. **agent_name**: REQUIRED. Your agent identifier exactly as defined in subagents.yaml (e.g., "sre_linux", "sre_openshift", "sre_networking", "sre_ansible", "sre_ssh", "sre_package_management"). Must be included in every TicketPayload — use your own agent name, not the name of another agent.
